...
public class Algo {
    ...
    public Algo(double percent){
        ...
        selections = new String[]{"waist","height","weight","hips","age","walk","cigarettes",
                ...
                if(val != null) {
                    if (!val.equals("") && Arrays.stream(selections).anyMatch(n -> n.equals(field.getName()))) {
                            if(percent==0){
                                ...
                                if(field.getName().equals("age")){
                                ...
                                else if (field.getName().equals("height") && strHeight.equals("")) {
                                    if (!strWeight.equals("")) {
                                        if (iRangeIMB == 1) {
                                            str = "imb >=" + getMinIMB(val, strWeight) + " and " + "imb <" + getMaxIMB(val, strWeight) + " and ";
                                        } else {
                                            double p = percent;
                                            percent = 13.51 * (1 + (iRangeIMB - 2) * 1.96);
                                            str = "imb >=" + getMinK(getMinIMB(val, strWeight)) + " and " + "imb <" + getMaxK(getMaxIMB(val, strWeight)) + " and ";
                                            percent = p;
                                        }
                                    } else {
                                        strHeight = val;
                                    ...
                                    if (!strHeight.equals("")) {
                                        if (iRangeIMB == 1) {
                                            str = "imb >=" + getMinIMB(strHeight, val) + " and " + "imb <" + getMaxIMB(strHeight, val) + " and ";
                                        } else {
                                            double p = percent;
                                            percent = 13.51 * (1 + (iRangeIMB - 2) * 1.96);
                                            str = "imb >=" + getMinK(getMinIMB(strHeight, val)) + " and " + "imb <" + getMaxK(getMaxIMB(strHeight, val)) + " and ";
                                            percent = p;
                                        }
                                    } else {
                                        strWeight = val;
